...
\textbf{3.3 Explain}
\\*
As you can see, the result on my local laptop and on my VPS is different. Because google has different IP address in world to enable fast routing to nearest server.
